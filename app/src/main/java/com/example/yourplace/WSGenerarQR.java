...
public class WSGenerarQR {
    ...
    public String borrar(String id){
        ...
        try {
            ...
            String data ="ID_QR="+ URLEncoder.encode(id, "UTF-8");
    ...
    // metodo de insertar
    public String insertar(String id, String nombre ,String sel,String notas) {
        String aux = "";
        try {
            ...
            String data ="&ID_QR="+URLEncoder.encode(id, "UTF-8")
                    +"&NOMBRE_QR="+URLEncoder.encode(nombre, "UTF-8")
    ...
    public String actualizar(String id, String nombre ,String sel,String notas) {
        String aux = "";
        try {
            //Establecer URL a consultar en servidor
