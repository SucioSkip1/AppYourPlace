...
public class WebServiceCatalogoInterfazNegocio {
    ...
    // metodo de insertar
    public String insertar(String id, String nombre ,String precio,String descripcion) {
        String aux = "";
        try {
    ...
    public String actualizar(String id, String nombre ,String precio,String descripcion) {
        String aux = "";
        try {
            //Establecer URL a consultar en servidor
